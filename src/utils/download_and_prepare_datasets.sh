...
for split in train dev test;
  do
    ...
    python src/utils/convert_num_to_text_labels.py -i datasets/trec/${split}.raw -o datasets/trec/${split}.tsv -d trec
    rm datasets/trec/${split}.raw
  done
python src/utils/create_fsl_dataset.py -datadir datasets/trec -num_train 10 -num_dev $NUMDEV -sim $NUMEXP -lower
...
for split in train dev test;
  do
    ...
    python src/utils/convert_num_to_text_labels.py -i datasets/stsa/${split}.raw -o datasets/stsa/${split}.tsv -d stsa
    rm datasets/stsa/${split}.raw
  done
python src/utils/create_fsl_dataset.py -datadir datasets/stsa -num_train 10 -num_dev $NUMDEV -sim $NUMEXP -lower
...
# python src/utils/create_fsl_dataset.py -datadir datasets/snips -num_train 10 -num_dev $NUMDEV -sim $NUMEXP -lower
